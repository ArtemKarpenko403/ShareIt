...
/**
 * REST-контроллер для управления вещами и комментариями.
 *
 * <p>Обрабатывает запросы по базовому пути <code>/items</code>, включая:
 * <ul>
 *     <li>Создание, обновление и получение информации о вещах</li>
 *     <li>Поиск доступных для бронирования вещей</li>
 *     <li>Добавление комментариев к вещам</li>
 * </ul>
 *
 * <p>Выполняет валидацию входящих данных и делегирует обработку запросов
 * микросервису ShareIt через {@link ItemClient}.
 *
 * <p>Все методы требуют аутентификации через заголовок X-Sharer-User-Id.
 */
