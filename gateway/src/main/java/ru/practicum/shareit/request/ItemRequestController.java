...
/**
 * Контроллер для работы с запросами на вещи (ItemRequest).
 *
 * <p>Обрабатывает REST-запросы по пути /requests:
 * <ul>
 *     <li>Создание и просмотр запросов</li>
 *     <li>Получение списка запросов</li>
 *     <li>Управление статусами запросов</li>
 * </ul>
 *
 * <p>Выполняет валидацию данных и взаимодействует с микросервисом ShareIt.
 */
@Controller
@Slf4j
