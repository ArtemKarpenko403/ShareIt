...
/**
 * REST-клиент для работы с запросами на вещи (ItemRequest).
 *
 * <p>Выполняет запросы к эндпоинтам /requests микросервиса ShareIt:
 * <ul>
 *     <li>GET - получение запросов</li>
 *     <li>POST - создание новых запросов</li>
 * </ul>
 *
 * <p>Использует настроенный RestTemplate для взаимодействия с API.
 */
