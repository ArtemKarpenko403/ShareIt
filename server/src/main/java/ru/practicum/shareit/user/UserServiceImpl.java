 ...
 *
 * <p>Предоставляет следующие операции:
 * <ul>
 *     <li>Создание и регистрация новых пользователей</li>
 *     <li>Обновление профилей существующих пользователей</li>
 *     <li>Поиск пользователей по идентификатору</li>
 *     <li>Получение полного списка пользователей</li>
 ...
 *     <li>Чтение данных выполняется без блокировок</li>
 *     <li>Использует UserRepository для доступа к данным</li>
 * </ul>
 */
