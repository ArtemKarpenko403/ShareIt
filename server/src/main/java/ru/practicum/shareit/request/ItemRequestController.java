...
/**
 * Конвертер между сущностью ItemRequest и DTO.
 * <p>Обеспечивает преобразование:
 * <ul>
 *     <li>ItemRequest ↔ ItemRequestCreateDto</li>
 *     <li>ItemRequest ↔ ItemRequestShortDto</li>
 *     <li>ItemRequest ↔ ItemRequestDto (с привязанными вещами)</li>
 * </ul>
 */
